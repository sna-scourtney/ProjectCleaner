...
private:
	...
	void OnPathReveal() const;
	void OnPathExpandRecursive() const;
	void OnPathCollapseRecursive() const;
	void OnPathExclude();
	void OnPathInclude();
	...
	void OnAssetsExclude();
	void OnAssetsExcludeByClass();
	void OnAssetsInclude();
	void OnAssetsIncludeByClass();
	void OnAssetsDelete();
	void ScanProject();
	void UpdateStats();
	void UpdateTreeView();
	...
	bool CanExcludeAssets() const;
	bool CanIncludeAssets() const;
	...
	void OnShowFoldersUsed();
	void OnShowFoldersEngine();
	void OnExpandAll() const;
	void OnCollapseAll() const;
	ECheckBoxState GetFoldersEmptyActionState() const;
	ECheckBoxState GetFoldersExcludedActionState() const;
	ECheckBoxState GetFoldersUsedActionState() const;
	ECheckBoxState GetFoldersEngineActionState() const;
	void ResetFilters();
